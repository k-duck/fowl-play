...
public class DisableOffScreenObjects : MonoBehaviour
{
    ...
    public MeshCollider[] forceInclude;
    public MeshCollider[] forceRemove;
    ...
    public void RemoveUnseenObjects()
    {
        ...
        forceInclude = transform.Find("ForceInclude").GetComponents<MeshCollider>();
        forceRemove = transform.Find("ForceRemove").GetComponents<MeshCollider>();
    ...
    {
        foreach (MeshCollider inc in forceInclude)
        {
    ...
    {
        foreach (MeshCollider excl in forceRemove)
        {
