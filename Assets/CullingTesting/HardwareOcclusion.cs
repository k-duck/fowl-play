...
public class HardwareOcclusion : MonoBehaviour
{
    ...
    private void Start()
    {
		Targets = FindGameObjectsInLayer(10);
		GameObject[] wallTargets;
		//GameObject[] StaticTargets;
		//StaticTargets = FindGameObjectsInLayer(12);
		//wallTargets = FindGameObjectsInLayer(10);
		//Targets.Concat(StaticTargets);
		//Targets.Concat(wallTargets);
